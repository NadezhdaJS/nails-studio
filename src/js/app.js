...
// Первый слайдер
slider.init({
  parent: ".promotion-slider__slide",
  dot: ".slider-dot",
  arrowRight: ".promotion-slider__btn-next",
  arrowLeft: ".promotion-slider__btn-prev",
  sliderActive: "promotion-slider__slide--active",
  dotActive: "slider-dot--active",
});

// Второй слайдер
slider.init({
  parent: ".image-slider__item",
  dot: ".dot",
  arrowRight: ".image-slider__control-right",
